...
function Paris(){
        ...
        return(<>
            ...
            <NavBar />
            <div className="city">
            {data.cities.Paris.slice(0, 6).map((city)=>{
        ...
        : data.cities.Paris.slice(6,10).map((city)=>{
            return <div key={city.id} onClick={()=>goToProperty(city.id)}><ShowCard key={city.id} name={city.name} room={city.room} img={city.img} street={city.street} Bath={city.Bath}
